...
export async function listListingWeekSlotsRpc(args: { query: ListListingWeekSlotsQuery }) {
...
export async function listListingMonthSlotsRpc(args: { query: ListListingMonthSlotsQuery }) {
  const supabase = createPublicSupabaseClient();
